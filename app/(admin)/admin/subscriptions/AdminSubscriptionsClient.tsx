...
type Props = { initialItems: AdminSubscription[] };

export default function AdminSubscriptionsClient({ initialItems }: Props) {
  const [items, setItems] = useState<AdminSubscription[]>(initialItems);
