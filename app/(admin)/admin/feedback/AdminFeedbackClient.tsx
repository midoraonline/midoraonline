...
type Props = { initialItems: AdminFeedback[] };

export default function AdminFeedbackClient({ initialItems }: Props) {
  const [feedbackList, setFeedbackList] = useState<AdminFeedback[]>(initialItems);
