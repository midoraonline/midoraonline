  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-8 sm:space-y-10">
      <div className="dm-card p-6 sm:p-8 lg:p-10">
        <div className="h-7 w-60 rounded-xl bg-foreground/[0.08]" />
        <div className="mt-3 h-4 w-96 max-w-full rounded-xl bg-foreground/[0.06]" />
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="dm-card overflow-hidden">
            ...
            <div className="p-5 sm:p-6">
              <div className="h-4 w-64 max-w-full rounded-xl bg-foreground/[0.08]" />
              <div className="mt-4 h-4 w-24 rounded-xl bg-foreground/[0.06]" />
              <div className="mt-5 h-7 w-40 rounded-full bg-foreground/[0.06]" />
            </div>
          </div>
        ))}
      </div>
